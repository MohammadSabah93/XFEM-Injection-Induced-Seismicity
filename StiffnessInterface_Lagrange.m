function globalK = StiffnessInterface_Lagrange(params, connectivity, XYZ, NODES, CRACK, n, t, Sn, duf, dt, stickflag, elementType, PHI, omega, domain_length, nex)
...
nnzEst = avgBW * DOF_u;
globalK = spalloc (DOF_u,DOF_u,nnzEst);
counter = 1;
...
if stickflag(counter,1)==0
   ...
   D = t * (Ks * (t - (Ks*t)/(Ks - duf(counter,1) * Sn(counter,1) + damp/dt)))';
