function globalF = BoundaryFluidSource(boundaryConditions, R, E, NODES, elementType)
    
    
fluxBoundaries = boundaryConditions.fluxBoundaries;
