function globalF = InsituStress(params, connectivity, XYZ, PSI, PHI, NODES, CRACK, omega, domain_length, nex, elementType)
...
if (NEN == 0)
    ...
    localF = localF + gw(gpIndex) * B_u' * S * det(jacobian);
...
elseif NEN > 0
    ...
    if  CTN == 4 
        [gp, gw, J] = subDomain(7, PN, Xe, 1, 0, 0,CRACK);
    elseif HEN == 4
        [gp, gw, J] = subDomain(7, PN, Xe, 0, 0, 0,CRACK);
    else
        [gp, gw, J] = subDomain(3, PN, Xe, 0, 0, 0,CRACK);
    end
